...
class Client
{
    ...
    public function __construct(string $clientId, string $clientSecret, array $config = [], $retailer = null)
    {
    ...
    public function execute(
        ...
        $request = $request
            ...
            ->withHeader('Retailer', $this->retailer)
    ...
    private function setRetailer($retailer) {
        ...
        if($retailer) self::$headers['Retailer'] = $retailer;
    }
}
