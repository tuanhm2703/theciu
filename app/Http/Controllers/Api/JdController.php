...
class JdController extends Controller {
    public function index(Request $request) {
        ...
        $jds = Jd::select('from_date', 'to_date', 'short_description', 'status', 'job_type', 'group', 'name', 'slug', 'id', 'created_at', 'featured', 'general_requirement', 'position', 'quantity')->withCount('wishlists')->active()->orderBy('created_at', 'desc');
        if ($request->group) {
