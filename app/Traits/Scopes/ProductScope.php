...
trait ProductScope
{
    ...
    {
        return $q->available()->with('image:path,imageable_id,id,name', 'available_flash_sales', 'inventories.image', 'categories', 'inventories')->select('products.id', 'products.slug', 'products.name');
    }
