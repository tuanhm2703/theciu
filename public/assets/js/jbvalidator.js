(function ($) {
    ...
    $.fn.jbvalidator = function (options) {
        ...
        let errorMessages = {
            ...
            isNotBefore: "Time has to be before %s",
            isNotAfter: "Time has to be after %s",
        ...
        let checkAll = function (form, event, showErrorMessage = true) {
            ...
            $(thisForm)
                .find(selector)
                .each((i, el) => {
                    validationRun(el, thisEvent, showErrorMessage);
                });
            return STATUS;
        };
        ...
        let validationRun = function (el, event, isShowErrorMessage = true) {
            el.setCustomValidity("");
            let isReadonly = false;
            if (hasAttr(el, "readonly")) {
                isReadonly = true;
        ...
        let validator = {
            multiSelectMin: function (el) {
                if (
                    ...
                    if (
                        ...
                        return errorMessages.minSelectOption.sprintf(
                            mustSelectedCount
                        );
                    }
                }
            ...
            multiSelectMax: function (el) {
                if (
                    ...
                    if (
                        ...
                        return errorMessages.maxSelectOption.sprintf(
                            mustSelectedCount
                        );
                    }
                }
            ...
            groupCheckBox: function (el, event) {
                if (hasAttr(el, "type", "checkbox")) {
                    ...
                    let groupRequired =
                        typeof $(checkGroup).data("vRequired") === "undefined"
                            ? 0
                            : 1;
                    ...
                    if (checkGroup) {
                        ...
                        if (
                            ...
                            if ($(el).prop("checked") === false) {
                                return errorMessages.groupCheckBox.sprintf(
                                    mustCheckedCount
                                );
                            }
                        }
            ...
            customMin: function (el) {
                if (hasAttr(el, "data-v-min")) {
                    ...
                    if (
                        isNaN(value) &&
                        ($(el).prop("require") || value.length > 0)
                    ) {
            ...
            customRequired: function (el) {
                if (hasAttr(el, "data-v-required")) {
                    const val = $(el).val();
                    if (val == "") {
            ...
            before: function (el) {
                if (hasAttr(el, "data-v-before")) {
                    const otherElementName = $(el).data("vBefore")
                    const otherElement = `input[name="${otherElementName}"]`
                    const val = $(el).val();
                    if ($(otherElement).val() < val) {
                        return errorMessages.isNotBefore.sprintf(
                            $(otherElement).val()
                        );
                    }
                }
            ...
            after: function (el) {
                if (hasAttr(el, "data-v-after")) {
                    const otherElementName = $(el).data("vAfter")
                    const otherElement = `input[name="${otherElementName}"]`
                    const val = $(el).val();
                    if ($(otherElement).val() > val) {
                        return errorMessages.isNotAfter.sprintf(
                            $(otherElement).val()
                        );
                    }
                }
        ...
        let HTML5Default = function (el) {
            if (el.validity.valueMissing) {
                if (el.tagName === "INPUT") {
                    if (
                        typeof errorMessages.HTML5.valueMissing.INPUT[
                            el.type
                        ] === "undefined"
                    ) {
                        return errorMessages.HTML5.valueMissing.INPUT.default;
                    ...
                    if (
                        typeof errorMessages.HTML5.valueMissing[el.tagName] !==
                        "undefined"
                    ) {
                ...
                if (
                    typeof errorMessages.HTML5.typeMismatch[el.type] !==
                    "undefined"
                ) {
                ...
                if (
                    typeof errorMessages.HTML5.rangeOverflow[el.type] !==
                    "undefined"
                ) {
                    ...
                    return errorMessages.HTML5.rangeOverflow[el.type].sprintf(
                        max
                    );
                }
            } else if (el.validity.rangeUnderflow) {
                if (
                    typeof errorMessages.HTML5.rangeUnderflow[el.type] !==
                    "undefined"
                ) {
                    ...
                    return errorMessages.HTML5.rangeUnderflow[el.type].sprintf(
                        min
                    );
                }
            } else if (el.validity.stepMismatch) {
                if (
                    typeof errorMessages.HTML5.stepMismatch[el.type] !==
                    "undefined"
                ) {
                    ...
                    return errorMessages.HTML5.stepMismatch[el.type].sprintf(
                        step,
                        step
                    );
                }
                ...
                let value = $(el).val();
                return errorMessages.HTML5.tooLong.sprintf(
                    minLength,
                    value.length
                );
                ...
                let value = $(el).val();
                return errorMessages.HTML5.tooShort.sprintf(
                    maxLength,
                    value.length
                );
                ...
                if (
                    typeof errorMessages.HTML5.badInput[el.type] !== "undefined"
                ) {
