                ...
                <div class="col-sm-6 col-lg-3">
                    <div class="widget">
                        ...
                        <ul class="widget-list">
                            ...
                            <li><a href='http://online.gov.vn/Home/WebDetails/106122'><img width="150px" alt='Chứng nhận đã khai báo với Bộ Công Thương' title='Chứng nhận đã khai báo với Bộ Công Thương' src='https://online.gov.vn/Content/EndUser/LogoCCDVSaleNoti/logoSaleNoti.png'/></a></li>
                        </ul>
                    </div>
                </div>
                <div class="col-sm-6 col-lg-3">
