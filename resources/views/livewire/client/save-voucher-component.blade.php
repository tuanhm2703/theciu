<div class="w-100 box-shadow p-1">
    ...
    <div class="voucher-condition-detail" data-voucher-id="{{ $voucher->id }}">
        ...
        <div class="voucher-condition-info-group mb-2">
            ...
            <span class="info-content">{{ $voucher->begin->format('d/m/Y H:i') }} - {{ $voucher->end->format('d/m/Y H:i') }}</span>
        </div>
        <div class="voucher-condition-info-group mb-2">
