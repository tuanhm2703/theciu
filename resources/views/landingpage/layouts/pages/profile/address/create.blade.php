<div wire:ignore.self class="modal fade" id="createAddressModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalSignTitle"
    aria-hidden="true">
                ...
                <div class="form-box position-relative pb-0" style="height: 600px; overflow: scroll">
                    ...
                    padding: 1rem;">
                        ...
                        <a class="ajax-modal-btn btn" id="return-address-list-btn" data-modal-size="modal-md"
                            data-link="{{ route('client.auth.profile.address.view.change') }}"><i
