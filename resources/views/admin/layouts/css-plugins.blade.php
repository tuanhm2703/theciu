...
<link id="pagestyle" href="{{ asset('assets/css/multiple-image-video.css') }}" rel="stylesheet" />
<link href="{{ asset('assets/css/select2-4.0.0.min.css') }}" rel="stylesheet" />
...
<link rel="stylesheet" href="{{ asset('assets/css/simple-notify.min.css') }}" />
