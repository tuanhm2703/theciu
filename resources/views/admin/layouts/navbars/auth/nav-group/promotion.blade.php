    ...
    <ul class="list-unstyled ps-0">
        <li class="mb-1">
            <div class="btn-toggle align-items-center rounded collapsed" data-bs-toggle="collapse"
                data-bs-target="#promotion-collapse" aria-expanded="{{ isNavActive('admin.event') || isNavActive('admin.promotion') ? 'true' : 'false' }}">
            ...
            <div class="collapse {{ isNavActive('admin.event') || isNavActive('admin.promotion') ? 'show' : 'hide' }}" id="promotion-collapse">
                <ul class="btn-toggle-nav list-unstyled fw-normal pb-1 small">
                    ...
                    <a class="nav-link {{ isNavActive('admin.event.index') ? 'active' : '' }}"
                        href="{{ route('admin.event.index') }}">
                        <div
                            class="icon icon-shape icon-sm border-radius-md text-center me-2 d-flex align-items-center justify-content-center">
                        </div>
                        <span class="nav-link-text ms-1">{{ trans('labels.event_list') }}</span>
                    </a>
                </ul>
            </div>
        </li>
