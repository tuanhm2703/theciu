                    ...
                    <div class="row mt-2">
                        ...
                        <div class="col-3 d-flex">
                            <div class="input-group height-fit-content">
                                ...
                                <input type="number" data-product-id="${inventory.product_id}" data-inventory-id="${inventory.id}"
                            ...
                            <div class="input-group height-fit-content text-sm">
                                <input type="number" class="text-sm form-control promotion-percent-input" data-product-id="${inventory.product_id}"
    ...
    $('#promotion-update-btn').on('click', (e) => {
        if (validator.checkAll() == 0) {
            ...
            $.ajax({
                ...
                type: @json(isset($combo) ? 'PUT' : 'POST'),
                data: {
