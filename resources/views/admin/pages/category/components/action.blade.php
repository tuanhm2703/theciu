<div class="dropdown text-center">
    ...
    <ul class="dropdown-menu" aria-labelledby="dropdownMenuButton">
        <li>
            <a class="btn btn-link text-dark px-3 mb-0 ajax-modal-btn" href="javascript:;"
                data-link="{{ route('admin.category.edit', $category->id) }}">Chỉnh sửa</a>
        </li>
        <li>
            <button class="btn btn-link text-dark px-3 mb-0 ajax-modal-btn" href="javascript:;"
        ...
        <li>
            ...
            <button class="btn btn-link text-dark px-3 mb-0 ajax-confirm" href="javascript:;">{{ trans('labels.delete') }}</button>
            {!! Form::close() !!}
        </li>
    </ul>
</div>
